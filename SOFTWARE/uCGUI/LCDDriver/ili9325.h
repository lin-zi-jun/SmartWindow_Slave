...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD端口定义---------------- 
//#define	LCD_LED PGout(11) //LCD背光    		 PG11 	    
//LCD地址结构体
typedef struct
{
	u16 LCD_REG;
...
#define LCD_BASE        ((u32)(0x6C000000 | 0x000FFFFE))
...
void LCD_CtrlLinesConfig(void);//初始化
...
void LCD_DrawPoint(u16 x,u16 y,u16 POINT);											//画点
